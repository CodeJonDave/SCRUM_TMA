...
CREATE TABLE IF NOT EXISTS products
 ...
 CONSTRAINT fk_product_owner
     FOREIGN KEY (product_owner_id) REFERENCES users(user_id) -- Reference to the 'users' table.
...
CREATE TABLE IF NOT EXISTS products_olap (log_id SERIAL PRIMARY KEY, -- Unique identifier for each log entry.
...
CREATE TRIGGER trg_products_changes AFTER
INSERT
OR
UPDATE
OR
